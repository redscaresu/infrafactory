...
Scenario-driven OpenTofu generation and validation across **AWS**, **GCP**, **Scaleway** and **Genesys Cloud** — generated by an LLM, validated against deterministic mock servers in seconds, and, on Scaleway, optionally applied to the real API and destroyed again.
