...
func TestSandboxPreflightRejectsNonScalewayEndpoint(t *testing.T) {
	...
	_, err := sandboxEnvWithProjectDefault(sandboxTestRuntime(), "")
	if err == nil {
...
func TestSandboxPreflightAcceptsRealScalewayEndpoint(t *testing.T) {
	...
	if _, err := sandboxEnvWithProjectDefault(sandboxTestRuntime(), ""); err != nil {
...
func TestSandboxCommandEnvCarriesPlacementAndOmitsAPIURL(t *testing.T) {
	...
	env, err := sandboxEnvWithProjectDefault(sandboxTestRuntime(), "")
	if err != nil {
...
func TestSandboxEnvPinsFallbackProject(t *testing.T) {
	...
	env, err := sandboxEnvWithProjectDefault(sandboxTestRuntimeWithFallback("2397e80e-ec12-4a7e-819f-a2caba3867b6"), "")
	if err != nil {
		t.Fatalf("sandboxCommandEnv: %v", err)
	}
...
func TestSandboxEnvRejectsOrgAsFallbackProject(t *testing.T) {
	...
	_, err := sandboxEnvWithProjectDefault(sandboxTestRuntimeWithFallback("22222222-2222-2222-2222-222222222222"), "")
	if err == nil {
...
func TestSandboxEnvPrefersTheRunsOwnProject(t *testing.T) {
	...
	fallbackEnv, err := sandboxEnvWithProjectDefault(rt, "")
	...
	runEnv, err := sandboxEnvWithProjectDefault(rt, "33333333-3333-3333-3333-333333333333")
	require.NoError(t, err)
...
func TestSandboxEnvRefusesTheOrganizationDefaultAsRunProject(t *testing.T) {
	...
	rt := &CommandRuntime{}
	_, err := sandboxEnvWithProjectDefault(rt, orgID)
