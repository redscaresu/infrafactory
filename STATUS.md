...
- 🎯 **Baseline: 44/44 deterministic** + **fakegenesys v0.2.0** + **27 paired contracts across the family** (CI-enforced via `handlers/contract_audit_test.go` in all 4 siblings).
